...
module.exports = {app: {...app, ...cfg.app}, db: {...db, ...cfg.db}, log: {...log, ...cfg.log}, cache: {...cache, ...cfg.cache}, page: {...page, ...cfg.page}, routes: cfg.routes, cookie: cfg.cookie, tpl: {...tpl, ...cfg.tpl}};