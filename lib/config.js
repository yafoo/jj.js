...
const {app: config_app, view: config_view, db: config_db, log: config_log, cache: config_cache, page: config_page, routes: config_routes, cookie: config_cookie, tpl: config_tpl, ...rest} = loader(path.join(base_dir, './config'));
