...
/**
 * @typedef {{$: Record<string, any>, $$: Record<string, any>, $config: Record<string, any>, DEEP: string, CONTROLLER: string, ACTION: string}} Store
 * @type {import('async_hooks').AsyncLocalStorage<Store>}
 */
let storage;
if (!IN_WEBCONTAINER) {
